...
/**
 * Ranked list of the busiest contractors by completed jobs — top 5, platform-wide or within
 * whichever municipality the caller has filtered to. Kept as a local copy of the operational
 * admin dashboard's equivalent panel rather than an import (see SecurityIncidentMap.tsx).
 */
  ...
  return (
    <Panel title="Top Contractors">
      {ranked.length === 0 ? (
        ...
        >
          No contractors found for this scope.
        </Typography>
      ) : (
        <Stack spacing={2}>
